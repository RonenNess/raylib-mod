...
RLAPI void SetShaderValueTextureEx(Shader shader, int locIndex, Texture2D texture, int samplerSlot); // Set shader uniform value for texture (sampler2d)
...
RLAPI void DrawRectangleWithoutChangingTexture(Rectangle rec, Rectangle source, Vector2 sourceSize, Vector2 origin, float rotation, Color color, Vector3* normal);
...
RLAPI void SetTextureFilterWithoutBind(Texture2D texture, int filter);                                   // Set texture scaling filter mode without binding
RLAPI void SetTextureMinLodWithoutBind(Texture2D texture, int minLod);                                   // Set texture min LoD without binding
RLAPI void SetTextureWrapWithoutBind(Texture2D texture, int wrap);
...
RLAPI Model LoadObjModelFromMemory(const char* objData);                                    // Load obj model from memory (meshes)
...
RLAPI void DrawModelNoSetup(Model model, Shader shader, Matrix transform);                  // Draw model meshes without doing any setup to shader. this method just send mesh parts to GPU and render it.
RLAPI void DrawMeshNoSetup(Mesh mesh, Shader shader);                                       // Draw a mesh without doing any setup to shader. this method just send mesh parts to GPU and render it.
...
RLAPI void UpdateModelAnimationSmooth(Model model, ModelAnimation anim, float time);        // Update model animation pose with smooth transition between frames
RLAPI void ClearModelAnimations(Model model);                                               // Clear model previously-applied animations
